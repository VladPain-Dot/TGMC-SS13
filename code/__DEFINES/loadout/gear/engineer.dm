GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
	...
	/obj/item/explosive/plastique/trench = list(CAT_ENGSUP, "Trench charge", 2, "orange3"),
	/obj/item/explosive/plastique/detpack/trench = list(CAT_ENGSUP, "Better Trench charge", 3, "orange3"),
	...
	/obj/item/tool/pickaxe/plasmacutter = list(CAT_ENGSUP, "Plasma cutter", 18, "blue"),
	/obj/item/attachable/buildasentry = list(CAT_ENGSUP, "Build-A-Sentry Attachment", 23, "blue"),
	/obj/item/sentry_upgrade_kit = list(CAT_ENGSUP, "Upgrade kit TUR-B", 17, "blue"),
	...
	/obj/item/minelayer = list(CAT_ENGSUP, "M21 APRDS \"Minelayer\"", 5, "orange3"),
	/obj/item/storage/box/explosive_mines = list(CAT_ENGSUP, "M20 mine box", 4, "orange3"),
	/obj/item/storage/box/explosive_mines/large = list(CAT_ENGSUP, "Large M20 mine box", 7, "orange3"),
	...
	/obj/item/storage/pouch/explosive/razorburn = list(CAT_ENGSUP, "Pack of Razorburn grenades", 8, "orange3"),
	/obj/item/explosive/grenade/chem_grenade/razorburn_large = list(CAT_ENGSUP, "Razorburn canister", 4, "orange3"),
	/obj/item/explosive/grenade/chem_grenade/razorburn_small = list(CAT_ENGSUP, "Razorburn grenade", 1, "orange3"),
	...
	/obj/item/ammo_magazine/flamer_tank/large = list(CAT_ENGSUP, "Flamethrower tank", 2, "orange2"),
))
